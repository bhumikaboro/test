!function() {
    ...
    function S1(d, $) {
        var n = _($);
        return ($ = f($, 1))in A ? v(d, n, $ = b(d, $, C1($)), -1) : 1
    }
    function m1(d, $, n, t, e, r) {
        ...
        !((i = u.substring(o).match(d1)) && null != i[1] && 0 < i[1].length && "0" == I(i[1], q)) && ($.i = "",
        $.g(u.substring(o)),
        !0))) ? 5 : 20),
        e && h(r, 6, u),
        20 == u)
    ...
    d("intlTelInputUtils.isValidNumber", function(d, $) {
        try {
            var n, t = E.g(), e = O(t, d, $), r = p1(t, e), i = f(e, 1), u = b(t, i, r);
            if (!(n = null == u)) {
                if (l = "001" != r) {
                    var o = L(t, r);
                    if (null == o)
