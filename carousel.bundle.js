!function(e, t) {
    ...
    var e = {
        25573: (e, t, s) => {
                ...
                for (let n = 1; n < e.length; n += 1) {
                    ...
                    !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
                        ...
                        for (let s = 0, i = e.length; s < i; s += 1) {
                            ...
                            void 0 !== n && n.enumerable && (b(t[i]) && b(a[i]) ? a[i].__swiper__ ? t[i] = a[i] : y(t[i], a[i]) : !b(t[i]) && b(a[i]) ? (t[i] = {},
                            a[i].__swiper__ ? t[i] = a[i] : y(t[i], a[i])) : t[i] = a[i])
                        }
                    }
                }
                var i;
              ...
              , $ = {
                ...
                updateSlides: function() {
                    ...
                    for (let n = 0; n < c; n += 1) {
                        x = 0;
                        const r = p.eq(n);
                        if (E && e.grid.updateSlide(n, r, c, t),
                        "none" !== r.css("display")) {
                            if ("auto" === i.slidesPerView) {
                                ...
                                i.roundLengths && (x = Math.floor(x)),
                                p[n] && (p[n].style[t("width")] = `${x}px`);
                            p[n] && (p[n].swiperSlideSize = x),
                            f.push(x),
                ...
                updateSlidesProgress: function(e=this && this.translate || 0) {
                    ...
                    for (let e = 0; e < i.length; e += 1) {
                        ...
                        const d = (r + (s.centeredSlides ? t.minTranslate() : 0) - o) / (l.swiperSlideSize + s.spaceBetween)
                          , p = (r - a[0] + (s.centeredSlides ? t.minTranslate() : 0) - o) / (l.swiperSlideSize + s.spaceBetween)
                          , c = -(r - o)
            ...
            function k({swiper: e, runCallbacks: t, direction: s, step: i}) {
                ...
                let r = s;
                if (r || (r = n > a ? "next" : n < a ? "prev" : "reset"),
                e.emit(`transition${i}`),
                t && n !== a) {
                    if ("reset" === r)
            ...
            const O = {
                slideTo: function(e=0, t=this.params.speed, s=!0, i, n) {
                    ...
                    let r = e;
                    r < 0 && (r = 0);
                    const {params: l, snapGrid: o, slidesGrid: d, previousIndex: p, activeIndex: c, rtlTranslate: u, wrapperEl: h, enabled: f} = a;
                    ...
                    if (a.initialized && r !== c) {
                        if (!a.allowSlideNext && v < a.translate && v < a.minTranslate())
                            return !1;
                        if (!a.allowSlidePrev && v > a.translate && v > a.maxTranslate() && (c || 0) !== r)
                            return !1
                    }
                    let w;
                    if (r !== (p || 0) && s && a.emit("beforeSlideChangeStart"),
                    a.updateProgress(v),
            ...
            function L(e) {
                ...
                u && p.target && p.target.shadowRoot && h && (c = g(h[0]));
                ...
                if (a.swipeHandler && !c.closest(a.swipeHandler)[0])
                    return;
                ...
                "touchstart" !== p.type) {
                    ...
                    s.activeElement && g(s.activeElement).is(n.focusableElements) && s.activeElement !== c[0] && s.activeElement.blur();
            ...
            function A(e) {
                ...
                s.isMoved = !1,
                s.startMoving = !1,
                c = i.followFinger ? a ? t.translate : -t.translate : -s.currentTranslate,
                i.cssMode)
                    return;
                ...
                if (p > i.longSwipesMs) {
                    ...
                    "prev" === t.swipeDirection && t.slideTo(null !== m ? m : u)) : o.target === t.navigation.nextEl ? t.slideTo(u + b) : t.slideTo(u)
                }
            }
            function I() {
                const e = this
            ...
            const N = (e, t) => {
                ...
                if (d.touch) {
                    ...
                    a[c](n.move, e.onTouchMove, d.passiveListener ? {
                        passive: !1,
                        capture: p
                    } : p),
              ...
              , j = {
                attachEvents: function() {
                    ...
                    e.onClick = D.bind(e),
                    i.touch && !G && (t.addEventListener("touchstart", V),
                    G = !0),
                    N(e, "on")
                },
            ...
            const W = {
                ...
                translate: {
                    ...
                    setTranslate: function(e, t) {
                        ...
                        p = Math.floor(p)),
                        n.cssMode ? r[s.isHorizontal() ? "scrollLeft" : "scrollTop"] = s.isHorizontal() ? -d : -p : n.virtualTranslate || a.transform(`translate3d(${d}px, ${p}px, 0px)`),
                ...
                breakpoints: {
                    setBreakpoint: function() {
                        ...
                        const o = (l in r ? r[l] : void 0) || e.originalParams
                          ...
                          , p = _(e, o)
                          , c = n.enabled;
                        d && !p ? (a.removeClass(`${n.containerModifierClass}grid ${n.containerModifierClass}grid-column`),
                        e.emitContainerClasses()) : !d && p && (a.addClass(`${n.containerModifierClass}grid`),
                ...
                images: {
                    loadImage: function(e, t, s, i, n, a) {
                        ...
                        g(e).parent("picture")[0] || e.complete && n ? d() : t ? (l = new r.Image,
                        l.onload = d,
                        l.onerror = d,
                        i && (l.sizes = i),
                        s && (l.srcset = s),
                    ...
                    i.device = function(e={}) {
                        return E || (E = function({userAgent: e}={}) {
                            ...
                            const c = n.match(/(iPod)(.*OS\s([\d_]+))?/)
                              ...
                              , h = "Win32" === i;
                            let f = "MacIntel" === i;
                            return !p && f && t.touch && ["1024x1366", "1366x1024", "834x1194", "1194x834", "834x1112", "1112x834", "768x1024", "1024x768", "820x1180", "1180x820", "810x1080", "1080x810"].indexOf(`${r}x${l}`) >= 0 && (p = n.match(/(Version)\/([\d.]+)/),
                            p || (p = [0, 1, "13_0_0"]),
                            f = !1),
                            d && !h && (a.os = "android",
                            a.android = !0),
            ...
            function Q({swiper: e, extendParams: t, on: s, emit: i}) {
                ...
                function d() {
                    ...
                    "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
                        ...
                        let n, l, c;
                        if (s.dynamicBullets && (a = i.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0),
                    ...
                    if ("fraction" === s.type && (d.find(J(s.currentClass)).text(s.formatFractionCurrent(p + 1)),
                    d.find(J(s.totalClass)).text(s.formatFractionTotal(c))),
                    "progressbar" === s.type) {
                        let t;
                        ...
                        d.find(J(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${a})`).transition(e.params.speed)
                    }
                ...
                function p() {
                    ...
                    if ("bullets" === t.type) {
                        ...
                        n.html(a),
                        e.pagination.bullets = n.find(J(t.bulletClass))
                    }
                ...
                s("init", ( () => {
                    !1 === e.params.pagination.enabled ? h() : (c(),
                    p(),
                    d())
                }
                )),
            ...
            function Z({swiper: e, extendParams: t, on: s, emit: i}) {
                ...
                function l() {
                    return void 0 === n && !e.autoplay.running && (e.autoplay.running = !0,
                    i("autoplayStart"),
                    a(),
                    !0)
                }
                function o() {
                    return !!e.autoplay.running && void 0 !== n && (n && (clearTimeout(n),
                    n = void 0),
            ...
            function ee({swiper: e, extendParams: t}) {
                let s, i, n;
                t({
                    grid: {
                        rows: 1,
                    ...
                    updateSlide: (t, a, r, l) => {
                        ...
                        if ("row" === c && o > 1) {
                            const e = Math.floor(t / (o * p))
                              , i = t - p * o * e
                              , n = 0 === e ? o : Math.min(Math.ceil((r - e * p * o) / p), o);
                            f = Math.floor(i / n),
                            h = i - f * n + e * o,
                            u = h + f * s / p,
                            a.css({
                            ...
                            (h > n || h === n && f === p - 1) && (f += 1,
                            f >= p && (f = 0,
                            h += 1))) : (f = Math.floor(t / i),
                            h = t - f * i);
                        a.css(l("margin-top"), 0 !== f ? d && `${d}px` : "")
                    }
                    ,
                    updateWrapperSize: (t, i, n) => {
                        const {spaceBetween: a, centeredSlides: r, roundLengths: l} = e.params
                          , {rows: o} = e.params.grid;
                        if (e.virtualSize = (t + a) * s,
                        e.virtualSize = Math.ceil(e.virtualSize / o) - a,
                        e.$wrapperEl.css({
            ...
            function te(e, t, s) {
                ...
                let a = n.children(`.${i}`);
                return a.length || (a = g(`<div class="swiper-slide-shadow${s ? `-${s}` : ""}"></div>`),
                n.append(a)),
                a
            }
            function se(e, t) {
                    ...
                    setTranslate: () => {
                        ...
                        for (let e = 0, t = i.length; e < t; e += 1) {
                            const t = i.eq(e)
                              ...
                              , c = "function" == typeof a.modifier ? a.modifier(l) : l * a.modifier;
                            let u = r ? d * c : 0
                              , h = r ? 0 : d * c
                              , f = -p * Math.abs(c)
                              , m = a.stretch;
                            ...
                            a.slideShadows) {
                                ...
                                0 === e.length && (e = te(a, t, r ? "left" : "top")),
                                0 === s.length && (s = te(a, t, r ? "right" : "bottom")),
                                e.length && (e[0].style.opacity = c > 0 ? c : 0),
                                s.length && (s[0].style.opacity = -c > 0 ? -c : 0)
                            }
                        }
                    }
                    ,
    ...
    n.Ay.use([n.dK, n.Vx, n.xA, n.t9, n.Ij]);
    var o = {
        1: {},
        2: {
            pagination: {
        ...
        l2: l({
            ...
            navigation: {
                nextEl: ".swiper-button-next-l2",
                prevEl: ".swiper-button-prev-l2"
            }
        }, "pagination", {
    ...
    document.querySelectorAll(".bb-carousel").forEach((function(e) {
        ...
        if (t) {
            var s = function(e) {
                var t = {
                  ...
                  , s = e.querySelector("input.slider-settings");
                if (s) {
                    var i = JSON.parse(s.value);
                    t = r(r({}, t), i),
                    s.remove()
                }
                return s ? t : {}
              ...
              , i = t.dataset.sid
              , a = t.dataset.layout || "1"
              , l = r({}, o[a])
              , d = s.pagination
              , p = void 0 === d ? {} : d;
            if ("g1" !== a && (p.position = 2),
            p.enabled && (2 == s.pagination.type ? l.pagination = {
                dynamicBullets: !0,
                clickable: !0
            } : 3 == s.pagination.type ? l.pagination = {
                type: "fraction"
            } : 4 == s.pagination.type ? (l.pagination = {
                type: "progressbar"
            },
            p.position = 1,
            t.style["padding-top"] = "4px") : (l.pagination = {
                clickable: !0,
                type: "bullets"
            },
            5 == s.pagination.type && (l.pagination.bulletClass = "swiper-pagination-bullet bullet-style-2")),
            l.pagination.el = ".swiper-pagination-".concat(i)),
            !p.enabled || 1 == p.position) {
                var c = e.querySelector(".swiper-pagination");
                c && (p.enabled ? (c.classList.remove("pagination-out"),
                t.append(c)) : c.remove())
            }
            var u = s.navigation
              , h = void 0 === u ? {} : u;
            if (h.enabled && (l.navigation = {
                nextEl: ".swiper-button-next-".concat(i),
                prevEl: ".swiper-button-prev-".concat(i)
            }),
            !h.enabled || 1 == h.position) {
                var f = e.querySelector(".navigation-container");
                if (f) {
                    if (h.enabled) {
            ...
            l.loop = !!s.loop,
            l.autoplay = !!s.autoplay && {
                delay: 2e3,
                disableOnInteraction: !0,
                stopOnLastSlide: !0
            },
            l.breakpoints && (l.breakpoints = r({}, l.breakpoints),
            3 == s.cols && delete l.breakpoints[992],
            2 == s.cols && (delete l.breakpoints[992],
            delete l.breakpoints[768])),
            new n.Ay(t,l)
        }
    }
    )),
    document.querySelectorAll(".product-images .swiper").forEach((function(e) {
        new n.Ay(e,{
            pagination: {
                el: ".swiper-pagination",
                type: "bullets"
